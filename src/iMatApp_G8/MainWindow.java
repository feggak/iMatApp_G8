...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		btnRecept.setForeground(new Color(255, 255, 255));
		...
		txtSearch.setBounds(226, 7, 431, 34);
		topPanel.add(txtSearch);
		txtSearch.setColumns(1);
		
		JButton btnLoggaIn = new JButton("Logga in");
		btnLoggaIn.setForeground(new Color(255, 255, 255));
		...
		btnLoggaIn.setBounds(663, 7, 110, 34);
		topPanel.add(btnLoggaIn);
		
		JButton btnTillKassan = new JButton("Till kassan");
		btnTillKassan.setForeground(new Color(255, 255, 255));
		...
		btnTillKassan.setBounds(934, 7, 110, 34);
		topPanel.add(btnTillKassan);
		
		JLabel lblNewLabel_1 = new JLabel("22 varor | 123 kr");
		lblNewLabel_1.setForeground(new Color(255, 255, 255));
		lblNewLabel_1.setFont(new Font("Helvetica", Font.BOLD, 13));
		lblNewLabel_1.setBounds(790, 26, 120, 16);
		topPanel.add(lblNewLabel_1);
		
		JButton btnKundvagn = new JButton("Kundvagn");
		btnKundvagn.setRolloverEnabled(true);
		btnKundvagn.setVerticalAlignment(SwingConstants.TOP);
		btnKundvagn.setForeground(new Color(255, 255, 255));
		...
		btnKundvagn.setFont(new Font("Helvetica", Font.PLAIN, 16));
		btnKundvagn.setBorder(new CompoundBorder(new MatteBorder(0, 1, 0, 0, (Color) new Color(0, 0, 0)), new EmptyBorder(7, 9, 9, 9)));
		btnKundvagn.setBackground(new Color(255, 59, 33));
		btnKundvagn.setAlignmentY(0.0f);
		btnKundvagn.setBounds(779, 1, 150, 46);
		topPanel.add(btnKundvagn);
		
		JPanel leftCategoryPanel = new JPanel();
		leftCategoryPanel.setMinimumSize(new Dimension(220, 10));
		leftCategoryPanel.setSize(new Dimension(220, 0));
		...
		leftCategoryPanel.setLayout(new MigLayout("", "[1px]", "[1px][][][][][][]"));
		...
		leftCategoryPanel.add(lblNewLabel, "cell 0 0,grow");
		...
		leftCategoryPanel.add(lblVisaAllaVaror, "cell 0 1,grow");
		...
		leftCategoryPanel.add(separator, "cell 0 2,grow");
		...
		leftCategoryPanel.add(lblFruktGrnt, "cell 0 3,grow");
		...
		leftCategoryPanel.add(lblBrd, "cell 0 4,grow");
		
		JPanel mainPanel = new StoreView();
